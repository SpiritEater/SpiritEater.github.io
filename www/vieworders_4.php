...
<h1>Музыкальные инструменты от Боба</h1>
...
echo "$number_of_orders";
  ...
  echo '<tr><th bgcolor = \"#CCCCFF\">Дата заказа</th>' .
            ...
            '<th bgcolor = \"#CCCCFF\">Гитар Fender</th>' .

            '<th bgcolor = \"#CCCCFF\">Медиаторов Ibanez</th>' .

            '<th bgcolor = \"#CCCCFF\">Струн Diaddario</th>' .

            '<th bgcolor = \"#CCCCFF\">Комбоусилителей Marshall</th>' .
