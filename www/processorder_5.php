...
function zakaz($tireqty, $oilqty, $sparkqty, $address, $fio)
...
$services -> Setnazvanie('Лабораторные работы по курсу "Веб-программирование" <br> Студента группы ПИс-141: Барменко Максима Евгеньевича <br> Проверил: к.т.н. доц. Назимов А.С.');
